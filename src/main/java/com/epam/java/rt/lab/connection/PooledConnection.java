...
public class PooledConnection implements Connection {
    ...
    PooledConnection(Properties properties) throws SQLException {
    ...
    void setShutdownProcess(boolean value) {
        this.shutdownProcess = value;
        logger.info("Pooled connection shutdown process set to '{}'", value);
    }
